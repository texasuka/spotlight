...
description: Landing page for all interviews
---

<PageDescription>


Spotlights are bi-monthly interviews done by the Informatics commitee of [UKA](https://texasuka.org).

스포트라이트는 매달 2회 [텍사스 한인 학생회](https://texasuka.org)에서 진행하는 인터뷰 프로그램입니다.
...
**Use the navigation on the left ** 옆에 사이드바로 원하시는 인터뷰를 보실 수 있습니다

**Use the search bar on the top ** 사이트 위쪽 검색기능을 이용하실 수 있습니다
...
This is a demo of a new Carbon team member spinning up a Gatsby Theme Carbon site while following the steps listed above. To forward through the introduction, play from min `3:50`.
